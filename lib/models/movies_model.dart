// ignore_for_file: unnecessary_this, unnecessary_new, prefer_void_to_null, unnecessary_question_mark, prefer_collection_literals, duplicate_ignore
...
class Created {
  ...
  Created({this.gravatarHash, this.id, this.name, this.username});
